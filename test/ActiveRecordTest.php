...
class ActiveRecordTest extends DatabaseTest
{
	 ...
	 * @expectedExceptionMessage Unknown key(s)
	 */
	...
	public function test_invalid_attributes()
	{
		...
		$this->assertContains('invalid_attribute', $exceptions[0]);
		$this->assertContains('another_invalid_attribute', $exceptions[1]);
	}

	/**
	 * @expectedException ActiveRecord\UndefinedPropertyException
	 * @expectedExceptionMessage Author->this_better_not_exist
	 */
	...
	public function test_hyphenated_column_names_to_underscore()
	{
		...
		$this->assertArrayHasKey('rm_name', RmBldg::first()->attributes());
	}
	...
	public function test_column_names_with_spaces()
	{
		...
		$this->assertArrayHasKey('space_out', RmBldg::first()->attributes());
	}

	public function test_mixed_case_column_name()
	{
		$this->assertArrayHasKey('mixedcasefield', Author::first()->attributes());
	}
	...
	public function test_active_record_model_home_not_set()
	{
		...
		$this->assertFalse(class_exists('TestAutoload'), 'class TestAutoload should not exist');
	...
	public function test_auto_load_with_model_in_secondary_model_directory(){
		...
		$this->assertTrue(class_exists('Backup'), 'class Backup should exist');
	...
	{
		$this->assertTrue(class_exists('NamespaceTest\Book'), 'class NamespaceTest\Book should exist');
	}
	...
	public function test_auto_load_with_namespaced_model_in_secondary_model_directory(){
		...
		$this->assertTrue(class_exists('NamespaceTest\Backup'), 'class NamespaceTest\Backup should exist');
	...
	*/
	...
	public function test_clear_cache_for_specific_class()
	{
		...
		$this->assertSame($book_table1, $book_table2);
		$this->assertNotSame($book_table1, $book_table3);
	}
	...
	public function test_changed_attributes() {
		...
		$this->assertInternalType('array', $changed_attributes);
		$this->assertCount(1, $changed_attributes);
		$this->assertArrayHasKey('type', $changed_attributes);
	...
	public function test_changes() {
		...
		$this->assertInternalType('array', $changes['type']);
	...
	public function test_previous_changes() {
		...
		$this->assertEmpty($previous_changes);
		$event->save();
		$previous_changes = $event->previous_changes();
		$this->assertInternalType('array', $previous_changes);
		$this->assertCount(1, $previous_changes);
		$this->assertArrayHasKey('type', $previous_changes);
		$this->assertInternalType('array', $previous_changes['type']);
	...
	public function test_save_resets_changed_attributes() {
		...
		$event->save();
		$changed_attributes = $event->changed_attributes();
		$this->assertEmpty($changed_attributes);
	}
	...
	public function test_changing_datetime_attribute_tracks_change() {
		...
		$this->assertArrayHasKey('created_at', $changes);
	...
	public function test_get_real_attribute_name()
	{
		...
		$this->assertNull($venue->get_real_attribute_name('invalid_field'));
	}
	...
	public function test_query()
	{
		...
		$this->assertGreaterThan(1, $row['n']);
